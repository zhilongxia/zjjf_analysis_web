...
public class AuthorityServiceImpl {
	...
	public ModelMsg dealScMgSuccessLogin(LoginVo loginRo, HttpServletRequest request, Model model) {
		...
		SecurityUtils.getSubject().getSession().setAttribute(SessionConfig.userAuthMap, getAuthInfoMap(userInfo.getUserName()));
	...
	private AuthInfo getAuthInfoMap(String userName) {
