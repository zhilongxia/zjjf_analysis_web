...
<table class="table-list table-border">
    ...
    <tbody class="table-tbody">
    	<tr ng-repeat="d_row in roleList">
    		...
    		<td class="table-op">
    			<a ng-href="<%=request.getContextPath() %>/api/authority/role/role_edit.do?menuId=25&id={{d_row.id}}" class="ml-default"><i class="icon-op icon-op-edit"></i> 编辑 </a>
                <a href="#" ng-click="deleteRolefun(d_row.id)" class="ml-default" ng-confirm-click="确定要删除这个角色么?"><i class="icon-op icon-op-del"></i> 删除</a>
                <a ng-href="<%=request.getContextPath() %>/api/authority/role/role_edit.do?menuId=25&id={{d_row.id}}" class="ml-default"><i class="icon-op icon-op-copy"></i> 角色复用 </a>
            </td>
    	</tr>
    </tbody>
</table>
