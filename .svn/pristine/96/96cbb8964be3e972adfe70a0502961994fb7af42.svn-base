...
public class AuthorityRoleController extends BaseController {
	...
	public @ResponseBody HashMap<String, Object> getRoleEditView(
		...
		resultMap.put("selectAllJson", authorityMenuService.getAllSelectPageKeyJson(Integer.valueOf(roleId)));
		return resultMap;
	}
	...
	public HashMap<String, Object> getPageKeyByMenuId(HttpServletRequest request) {
		...
		resultMap.put("selectAllJson", authorityMenuService.getSelectPageKeyJson(Integer.valueOf(roleId), Integer.valueOf(menuTwoId)));
